...
First, on the football pitch there are 11 players which can be categorized into multiple positions, which can be seen in the figure \ref{fig:positions}. In the figure \ref{fig:positions}, eleven players can be seen and nine different positions. For this project, the positions that will be analyzed are the strikers, winger, midfielders, full backs and central defenders. In the figure \ref{fig:positions} the \verb|Centre-backs| are the central defenders, the right- and left-back are the full backs, the Centre-midfielders are the midfielders, the Right- and Left-midfield are the wingers and lastly the Centre-forwards are the strikers.

Therefore, during this project some positions will be grouped together. So the positions full back and winger will cover both sides of the pitch, but still describe the general player playing on the side of the pitch and either offensively or defensively. The midfielder position present in the data describes a lot of different positions within the midfield. The figure \ref{fig:positions} has only one centre midfield positions, but in reality the midfielder can be an offensive midfielder or a defensive midfielder.

Since this limitation currently exists, the player qualities can be used to describe certain abilities of a player in certain areas of a position. In figure \ref{fig:positions_detailed}, the yellow circles depict the different types of midfielders on a football field. By looking at the figure \ref{fig:positions_detailed}, the different positions operate in different areas of the field. This means that the players use different attributes despite being categorized as a midfielder. Defensive midfielders are players playing further down the pitch, as can be seen in figure \ref{fig:positions_detailed}, providing the last line before the defense and therefore being a bigger part of the defensive aspect of the game and also a huge part in the build-up phase. The build-up phase is the part of football where a team tries to build up an attack from their goalkeeper or the defensive line. This means that a defensive midfielder does often need to be more attributed towards the defensive side as well as having a good passing ability to distribute the ball. 

At the same time, the attacking midfielder operates in the offensive areas of the pitch as depicted in figure \ref{fig:positions_detailed}. This often results in these players providing a late charge to the attacking side of the game, where these players need more attributes that favors goal-scoring, moving into the penalty area and finding the final pass before a goal.
...
As well as this, the qualities used as target variables for the midfielders are slightly different compared to the offensive qualities, which can be seen in table \ref{tab:general_qualities}. The midfielders are part of the build-up play and are the engines on the field, but also the players expected to move the ball around and find opportunities for their teammates. Therefore qualities such as passing quality and providing teammates are used as the target variables.
...
Lastly, the defenders qualities that are used as target variables are shown in table \ref{tab:defensive_qualities}. These qualities describes the defensive part of the game, where these positions aim to win the ball back in the case of an opposition attack and provide stability in front of their goalkeeper. 
